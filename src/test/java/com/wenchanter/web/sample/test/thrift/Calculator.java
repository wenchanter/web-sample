...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2014-11-14")
public class Calculator {
  ...
  public interface Iface {
    ...
    public int calculate(int id, String name) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void calculate(int id, String name, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public int calculate(int id, String name) throws org.apache.thrift.TException
    {
      send_calculate(id, name);
      return recv_calculate();
    }

    public void send_calculate(int id, String name) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void calculate(int id, String name, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      calculate_call method_call = new calculate_call(id, name, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class calculate_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int id;
      private String name;
      public calculate_call(int id, String name, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
        this.name = name;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class calculate<I extends Iface> extends org.apache.thrift.ProcessFunction<I, calculate_args> {
      ...
      public calculate_result getResult(I iface, calculate_args args) throws org.apache.thrift.TException {
        calculate_result result = new calculate_result();
        result.success = iface.calculate(args.id, args.name);
        result.setSuccessIsSet(true);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class calculate<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, calculate_args, Integer> {
      ...
      public void start(I iface, calculate_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws TException {
        iface.calculate(args.id, args.name,resultHandler);
      }
    }
...
;
  ...
  public static class calculate_args implements org.apache.thrift.TBase<calculate_args, calculate_args._Fields>, java.io.Serializable, Cloneable, Comparable<calculate_args>   {
    ...
    public calculate_args setId(int id) {
      this.id = id;
      setIdIsSet(true);
      return this;
    }
    ...
    public calculate_args setName(String name) {
      this.name = name;
      return this;
    }
